    ...
    function start() {
        if(!gameOver) {
            ...
            if(playing) {
                ...
                ctx.textAlign = "left";
                ctx.fillText('Kỷ lục: '+record+'', 20, 30);
            ...
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("Trò Chơi Kết Thúc",cW/2,cH/2 - 150);

            ctx.font = "20px Verdana";
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("Thiên thạch bị phá hủy: "+ destroyed, cW/2,cH/2 + 140);
            ...
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("Kỷ lục: "+ record, cW/2,cH/2 + 185);

            ctx.font = "15px Verdana";
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText("Trò chơi được phát triển bởi Nguyễn Ngọc Sơn",cW/2,cH/2 + 300);
