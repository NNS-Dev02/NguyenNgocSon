            ...
            <svg id="sprite-1" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg"
                ...
                <g stroke-linecap="round">
                    ...
                    <g id="head" transform="matrix(.5 0 0 .5 .011191 -.016144)">
                        ...
                        <ellipse id="eye" stroke-linejoin="round" style="color-rendering:auto;color:#00000;isolation:auto;mix-blend-mode:normal;shape-rendering:auto;solid-color:#000000;image-rendering:auto"
...
//-Độ dài X,Y mỗi lần nhấn phím bay-//
var hitboxWidth = 60;
var hitboxHeight = 15;
                      

 //-X,Y là nơi xuất phát trên màn hình-//
...
var minBoneHeight = -330; //-Độ cao,thấp nhất của cột dưới-//
var maxBoneHeight = -160;


var scrollSpeed = -1.5; //-Tốc độ bay-//
var gravity = 0.1; //-Trọng lực-//
var lift = -4; //-Độ nâng cao-//
var velocity = 0;
...
var bonePtr = 0;
var boneStart = 1500; //-Khoảng cách từ điểm bắt đầu-//
var flyGap = 165; //-Khoảng rộng của 2 cột trên dưới-//
var boneGap = 265; //-Khoản cách giữa các trụ-//
var bones = [
...
function render() {
  ...
  ctx.rotate(dinoAngle * Math.PI / 300);
  ctx.drawImage(
    dinoState,
    -hitboxWidth / 2,
