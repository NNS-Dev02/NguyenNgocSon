function CCardSelection(iMoney,oParentContainer){
    ...
    this._init = function(iMoney){
        ...
        _iTotBet = STARTING_BET * _iNumCards;
        _iIndexNumBalls = 0;
        ...
        _oMsgText =  new createjs.Text(TEXT_SELECT_CARD," 94px " +PRIMARY_FONT, "#ff7803");
        ...
        var oMsgOutlineText =  new createjs.Text(TEXT_SELECT_CARD," 94px " +PRIMARY_FONT, "#fff");
        oMsgOutlineText.x = CANVAS_WIDTH/2;
        oMsgOutlineText.y = 150;
        oMsgOutlineText.textAlign = "center";
        oMsgOutlineText.textBaseline = "middle";
        ...
        oSelectNumCardsText.y = 380;
        oSelectNumCardsText.textAlign = "center";
        oSelectNumCardsText.textBaseline = "middle";
        _oContainer.addChild(oSelectNumCardsText);
        ...
        _oButPlay = new CTextButton(_pStartPosPlay.x,_pStartPosPlay.y,s_oSpriteLibrary.getSprite('but_gui'),TEXT_PLAY,PRIMARY_FONT,"#ffffff",50,BUTTON_Y_OFFSET,_oContainer);
    ...
    this._initCards = function(){
        ...
        oPaytableText.textBaseline = "middle";
        _oContainer.addChild(oPaytableText);
