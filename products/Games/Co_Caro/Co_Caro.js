 ...
 if (computer) {
   if (player == computer) {
      if (checkWin(board, player)) {
        ...
        winner.innerHTML ="<h1>Thua mất rồi! 😥</h1>";
        }, 1400);
      return;
      } 
     }
   ...
   if (player == human) {
      if (checkWin(board, player)) {
         ...
         drawTheWinnersLine(board);  
         setTimeout(function() {
         winner.innerHTML ="<h1>Chiến thắng rồi! 😮</h1>";
        }, 1000);
      return;
        } 
      }
    ...
    if (player == player1) {
      ...
      drawTheWinnersLine(board);  
      setTimeout(function() {
      winner.innerHTML ="<h1>Người chơi 1 thắng !</h1>";
        }, 1000);
      return;
      } 
    }  else {
      if (checkWin(board, player)) {
         ...
         drawTheWinnersLine(board);  
         setTimeout(function() {
         winner.innerHTML ="<h1>Người chơi 2 thắng !</h1>";
        }, 1000);
      return;
      } 
