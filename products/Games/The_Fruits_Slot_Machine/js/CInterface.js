function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        _oInfoBut = new CTextButton(296 + (oSprite.width/2),595,oSprite,TEXT_INFO,FONT_GAME,"#ffffff",20,s_oStage);        
        ...
        _oBetCoinBut = new CTextButton(620 + (oSprite.width/2),595,oSprite,TEXT_COIN,FONT_GAME,"#ffffff",25,s_oStage);
	...
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2)+TEXT_CURRENCY,"24px "+FONT_GAME, "#ffde00");
        ...
        _oTotalBetText = new createjs.Text(TEXT_BET +":"+"\n"+iTotBet.toFixed(2)+"0 VNĐ","15px "+FONT_GAME, "#ffffff");
        _oTotalBetText.x = 918;
        _oTotalBetText.y = CANVAS_HEIGHT - 110;
        _oTotalBetText.textAlign = "center";
        _oTotalBetText.textBaseline = "alphabetic";
        s_oStage.addChild(_oTotalBetText);
        
        _oWinText = new createjs.Text("","15px "+FONT_GAME, "#ffde00");
        _oWinText.x = 1116;
        _oWinText.y = CANVAS_HEIGHT - 110;
    ...
    this.refreshTotalBet = function(iTotBet){
        _oTotalBetText.text = TEXT_BET +":"+"\n"+iTotBet.toFixed(2)+"0 VNĐ";
    };
