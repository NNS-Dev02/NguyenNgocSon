function CCreditsPanel(){
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("Nguyễn Ngọc Sơn\n(NNS-Dev02)", "34px " + FONT_GAME, "#000");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("Nguyễn Ngọc Sơn\n(NNS-Dev02)", "34px " + FONT_GAME, "#fff");
    ...
    this._onLogoButRelease = function(){
        window.open("https://nns-dev02.github.io/NguyenNgocSon/","_blank");
    };
